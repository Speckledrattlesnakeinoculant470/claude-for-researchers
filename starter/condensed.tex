% condensed.tex — short self-contained reference (target: 15–30 pages)
%
% USAGE BY CLAUDE:
...
%   - Cross-references to main.tex are provided so you can navigate there when
%     you need the derivation.
%   - Update this file whenever main.tex gets a new result, corrected formula,
...
% -----------------------------------------------------------------------
% CUSTOM COMMANDS — keep in sync with main.tex and CLAUDE.md
% -----------------------------------------------------------------------
...
\begin{theorem}[\established, see main.tex \S\ref{...}]
...
% Cross-reference main.tex for the derivation.
% Tag each result: [ESTABLISHED], [CONJECTURED], or [OPEN].

\begin{proposition}[\established, main.tex \S\ref{...}]
[Statement.]
\end{proposition}
