% main.tex — full research record
%
% USAGE BY CLAUDE:
%   - This is the AUTHORITATIVE, COMPREHENSIVE record of the project.
...
% -----------------------------------------------------------------------
% CUSTOM COMMANDS
% (add your notation here; keep in sync with condensed.tex and CLAUDE.md)
% -----------------------------------------------------------------------
