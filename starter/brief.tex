...
%   - Cross-references to manuscript.tex are provided so you can navigate there when
%     you need the derivation.
%   - Update this file whenever manuscript.tex gets a new result, corrected formula,
...
% -----------------------------------------------------------------------
% CUSTOM COMMANDS — keep in sync with manuscript.tex and CLAUDE.md
% -----------------------------------------------------------------------
...
\begin{theorem}[\established, see manuscript.tex \S\ref{...}]
...
% Cross-reference manuscript.tex for the derivation.
% Tag each result: [ESTABLISHED], [CONJECTURED], or [OPEN].

\begin{proposition}[\established, manuscript.tex \S\ref{...}]
[Statement.]
\end{proposition}
